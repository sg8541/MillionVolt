        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers("/api/v1/login/**", "/api/v1/signup/**", "/api/v1/findId/**","/api/v1/logout/**",
                                        "/api/v1/email/**","api/v1/charging-stations/**","/api/v1/email-check","/api/v1/id-check",
                                        "/api/v1/findPwd/**", "/api/v1/resetPwd/**", "/api/v1/myinfo/payment/**",
                                        "/charging/**", "/alarm/**","/api/v1/email/**","/chargerstatus/**", "/stomp-chargerstate/**","/app/charger/**", "/topic/charger/**", "/api/v1/penalty/**",
                                        "/api/v1/payment/**", "/reservationList/**", "/api/v1/reservation/**","/api/v1/payment/printstationinfo/**",
                                        "/api/v1/refundDeposit/**").permitAll() // 로그인 및 회원가입 엔드포인트는 누구나 접근 가능
